      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        <?php if(isset($_SESSION['usu_id'])){ 
         ...
         <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="?controlador=inicio&accion=frmContactar">Conocenos</a>
          </li>
         ...
         <?php if(!isset($_SESSION['usu_id'])){ ?>
           <li class="nav-item">
            <a href="?controlador=usuario&accion=CrearUsuario" class="btn btn-primary">Registrarse</a>
        </li>
         <li class="nav-item">
            <a class="nav-link" href="?controlador=inicio&accion=frmLogin">Iniciar seccion</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="?controlador=inicio&accion=frmContactar">Conocenos</a>
          </li>
